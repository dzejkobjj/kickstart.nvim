...
vim.api.nvim_create_autocmd('ModeChanged', {
  desc = 'Change to relative numbers in INPUT and absolute in others',
  callback = function()
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').add {
        { '<leader>c', desc = '[C]ode', group = 'which_key_ignore' },
        { '<leader>d', desc = '[D]ocument', group = 'which_key_ignore' },
        { '<leader>r', desc = '[R]ename', group = 'which_key_ignore' },
        { '<leader>s', desc = '[S]earch', group = 'which_key_ignore' },
        { '<leader>w', desc = '[W]orkspace', group = 'which_key_ignore' },
        { '<leader>t', desc = '[T]oggle', group = 'which_key_ignore' },
        { '<leader>h', desc = 'Git [H]unk', group = 'which_key_ignore' },
      }
      -- visual mode
      require('which-key').add {
        { '<leader>h', desc = 'Git [H]unk', group = 'which_key_ignore', mode = 'v' },
      }
    end,
  },
